...
class BrawInput final : public ImageInput {
    public:
        ...
        virtual const char* format_name(void) const override { return "BlackMagicRAW"; }
...
#define STRINGIFY(X) STRINGIFY2(X)
    ...
    filesystem::path lib_path(STRINGIFY(BlackMagicRAW_LIBRARIES));
    ...
    std::string gamut = config.get_string_attribute("BlackMagicRAW:gamut", "ACES APO");
    std::string gamma = config.get_string_attribute("BlackMagicRAW:gamma", "linear");
